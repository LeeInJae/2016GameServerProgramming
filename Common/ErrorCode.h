...
namespace NCommon
{
	...
	enum class ERROR_CODE : short
	{
		...
		ROOM_ENTER_EMPTY_ROOM = 299 ,

		LOBBY_CHAT_INVALID_DOMAIN = 305 ,
		LOBBY_CHAT_INVALID_LOBBY_INDEX = 306 ,

		LOBBY_WHISPER_CHAT_INVALID_DOMAIN = 305 ,
		LOBBY_WHISPER_CHAT_INVALID_LOBBY_INDEX = 306 ,
		LOBBY_WHISPER_CHAT_INVALID_TARGET = 307,
		LOBBY_WHISPER_CHAT_NOT_EQUAL_LOBBY_INDEX = 308,

		ROOM_MASTER_GAME_START_INVALID_INDEX = 315,
		ROOM_MASTER_GAME_START_INVALID_LOBBY_INDEX = 316 ,
		ROOM_MASTER_GAME_START_INVALID_ROOM_INDEX = 317 ,
		ROOM_MASTER_GAME_START_INVALID_MASTER = 318 ,
		ROOM_MASTER_GAME_START_GAME_INVALID_STATE = 319 ,
		ROOM_MASTER_GAME_START_GAME_INVALID_USER_COUNT = 320 ,
	};
}